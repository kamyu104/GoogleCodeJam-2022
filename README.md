...
|C| [ASeDatAb](https://codingcompetitions.withgoogle.com/codejam/round/000000000087711b/0000000000acd29b)| [Python3](./Round%201B/asedatab.py3) [Python3](./Round%201B/asedatab2.py3) | precompute: _O(L * 2^L)_<br>runtime: _O(L * 2^L)_ | _O(L * 2^L)_ | Hard | | Precompute, BFS, Topological Sort, Constructive Algorithms |
