...
|D| [Win As Second](https://codingcompetitions.withgoogle.com/codejam/round/00000000008779b4/0000000000b4518a)| [Python3](./Round%203/win_as_second.py3) [Python3](./Round%203/win_as_second2.py3) | _O(N^4 + M * N^3)_ | _O(N^3)_ | Hard | | Sprague-Grundy Theorem, BFS, Constructive Algorithms, Precompute, Trial and Error |
